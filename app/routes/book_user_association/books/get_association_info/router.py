...
from app.routes.book_user_association.books.get_association_info.rb import RBBookUserAssociation
from app.routes.book_user_association.books.get_association_info.schema import SBookUserAssociationGet
